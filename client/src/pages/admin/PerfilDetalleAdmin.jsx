...
const PerfilDetalleAdmin = () => {
  ...
  if (!student) {
    return (
      <div class="text-center py-20 text-carbon dark:text-white">
        <p>Estudiante no encontrado.</p>
        <Link to="/admin/perfiles" class="text-carbon dark:text-white mt-4 inline-block hover:underline">
          Volver a la lista
        </Link>
      </div>
    );
    ...
    <div class="space-y-6 pb-12">
      ...
      <div class="flex items-center gap-4">
        ...
        <div>
          ...
          <p class="text-gray-600 dark:text-gray-400 text-sm">Ficha técnica y progreso visual</p>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-1 space-y-6">
          <div class="bg-white dark:bg-[#0A0B0E] border border-carbon/30 dark:border-white/20 rounded-xl overflow-hidden relative shadow-[0_0_15px_rgba(201,162,39,0.1)]">
            <div class="h-24 bg-gradient-to-br from-[#1C1C21] to-[#0A0B0E] border-b border-carbon/10 dark:border-white/5 relative">
            ...
            <div class="px-6 pb-6 relative">
              ...
              <div class="text-center">
                <p class="text-xl font-body font-bold text-carbon dark:text-white uppercase leading-tight">{student.nombres} <br/> {student.apellidos}</p>
                
                <div class="mt-3 inline-flex px-3 py-1 bg-black/10 dark:bg-white/10 border border-carbon/30 dark:border-white/20 rounded-full text-carbon dark:text-white text-[10px] font-bold uppercase tracking-widest">
                  {student.grado}
                </div>
              </div>
              ...
              <div class="mt-8 space-y-4">
                <div class="bg-gray-50 dark:bg-[#1C1C21] p-3 rounded-lg border border-carbon/10 dark:border-white/5">
                  ...
                  <div class="space-y-2 text-xs">
                    ...
                    <div class="flex justify-between border-b border-carbon/10 dark:border-white/5 pb-1">
                      <span class="text-gray-600 dark:text-gray-400">Celular:</span>
                      <span class="text-carbon dark:text-white font-mono">{student.celular}</span>
                    </div>
                    <div class="flex justify-between border-b border-carbon/10 dark:border-white/5 pb-1">
                      <span class="text-gray-600 dark:text-gray-400">Ingreso:</span>
                      <span class="text-carbon dark:text-white font-mono">{student.fechaIngreso}</span>
                    </div>
                ...
                {student.alergias || student.enfermedades || student.lesiones ? (
                   <div class="bg-gray-50 dark:bg-[#1C1C21] p-3 rounded-lg border border-red-500/20">
                     <h4 class="text-[9px] text-red-400 uppercase tracking-widest mb-2 font-bold font-body">Consideraciones Médicas</h4>
        ...
        <div class="lg:col-span-2 space-y-4">
          <div class="bg-white dark:bg-[#0A0B0E] border border-carbon/20 dark:border-white/10 rounded-xl p-6 shadow-xl">
            <div class="flex justify-between items-center mb-6">
              <div>
                ...
                <p class="text-[11px] text-gray-600 dark:text-gray-400 mt-1">Registra la evolución visual del estudiante</p>
              </div>
              <button 
                onClick={() => setShowAddForm(!showAddForm)}
                class="flex items-center gap-2 bg-carbon dark:bg-white hover:bg-yellow-500 text-white dark:text-carbon font-bold px-4 py-2 rounded-lg text-xs transition-colors"
              >
              ...
              <div class="bg-gray-50 dark:bg-[#1C1C21] p-5 rounded-lg border border-carbon/30 dark:border-white/20 mb-8 animate-fade-in">
                <form onSubmit={handleUploadPhoto} class="space-y-4">
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-4">
                      <div>
                        <label class="block text-[10px] text-gray-600 dark:text-gray-400 uppercase tracking-widest mb-1 font-bold">Título / Descripción (Ej: Cinta Amarilla)</label>
                        <input 
                          type="text" 
            ...
            {student.gallery && student.gallery.length > 0 ? (
              ...
              <div class="text-center py-16 bg-gray-50 dark:bg-[#1C1C21] border border-carbon/10 dark:border-white/5 rounded-lg border-dashed">
                ...
                <p class="text-gray-600 dark:text-gray-400 text-sm">Este estudiante aún no tiene fotos en su galería de progreso.</p>
                <button 
