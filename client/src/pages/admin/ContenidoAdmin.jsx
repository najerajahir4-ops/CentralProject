        ...
        <form onSubmit={handleSave} class="space-y-4">
          ...
          <div>
            <div class="flex justify-between items-end mb-1">
              <label class="block text-xs font-bold text-gray-700 dark:text-gray-300 uppercase">Cuerpo / Contenido Completo</label>
              <button 
                type="button"
                onClick={handleInsertTemplate}
                class="text-[10px] font-bold uppercase tracking-wider bg-black/10 dark:bg-white/10 text-carbon dark:text-white border border-carbon/30 dark:border-white/20 px-3 py-1 rounded hover:bg-carbon dark:hover:bg-white hover:text-black transition-colors"
              >
