...
const LegalHub = () => {
  ...
  return (
    <div className="bg-blanco-absoluto min-h-screen text-carbon pb-24 font-body">
      {/* HEADER PRINCIPAL: Minimalista y Editorial */}
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-8 pt-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          {/* SIDEBAR NAVEGACIÓN (Estilo Stripe / Apple Legal) */}
                ...
                {tabs.map((tab) => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-full text-left py-2 pl-4 text-sm transition-colors -ml-px block ${
                        isActive
                          ? 'border-l-2 border-rojo-impacto text-carbon font-semibold'
          ...
          {/* CONTENIDO DEL DOCUMENTO ACTIVO (Lectura fluida y limpia) */}
          <main className="lg:col-span-9 max-w-3xl">
            ...
            {activeTab === 'privacidad' && (
              <article className="space-y-6 animate-fade-in text-gray-600 text-sm sm:text-[15px] leading-relaxed">
                <header className="border-b border-gray-200/80 pb-4">
                  <h2 className="text-2xl sm:text-3xl font-semibold text-carbon tracking-tight">
                ...
                <section className="space-y-2">
                  <h3 className="text-base font-semibold text-carbon pt-2">1. Responsable del Tratamiento</h3>
                  <p>
                ...
                <section className="space-y-2">
                  <h3 className="text-base font-semibold text-carbon pt-2">2. Principios de Tratamiento</h3>
                  <p>
                ...
                <section className="space-y-2">
                  <h3 className="text-base font-semibold text-carbon pt-2">3. Datos Recopilados y Finalidad</h3>
                ...
                <section className="space-y-2 border-l-2 border-rojo-impacto/50 pl-4 py-1 my-4 bg-gray-50/50 rounded-r">
                  <h3 className="text-sm font-semibold text-carbon">4. Tratamiento de Datos de Salud (Art. 25 LOPDP)</h3>
                ...
                <section className="space-y-2">
                  <h3 className="text-base font-semibold text-carbon pt-2">5. Protección de Menores de Edad</h3>
                  <p>
                ...
                <section className="space-y-3">
                  <h3 className="text-base font-semibold text-carbon pt-2">6. Derechos del Titular (ARCO)</h3>
                  <p>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
                    <div className="p-3 border border-gray-200/80 rounded-lg">
                      <p className="font-medium text-xs text-carbon">Acceso y Rectificación</p>
                      <p className="text-xs text-gray-500 mt-0.5">Conocer y corregir los datos registrados en el expediente.</p>
                    </div>
                    <div className="p-3 border border-gray-200/80 rounded-lg">
                      <p className="font-medium text-xs text-carbon">Supresión y Revocatoria</p>
                      <p className="text-xs text-gray-500 mt-0.5">Solicitar el retiro de información o revocar el consentimiento voluntario.</p>
                    </div>
                  </div>
                ...
                <section className="space-y-2">
                  <h3 className="text-base font-semibold text-carbon pt-2">7. Seguridad y Cero Comercialización</h3>
                  <p>
            ...
            {activeTab === 'terminos' && (
              <article className="space-y-6 animate-fade-in text-gray-600 text-sm sm:text-[15px] leading-relaxed">
                ...
                <section className="space-y-2">
                  <h3 className="text-base font-semibold text-carbon pt-2">1. Membresía y Formación Marcial</h3>
                  <p>
                ...
                <section className="space-y-2">
                  <h3 className="text-base font-semibold text-carbon pt-2">2. Política de Pagos y Mensualidades</h3>
                ...
                <section className="space-y-2">
                  <h3 className="text-base font-semibold text-carbon pt-2">3. Indumentaria y Equipamiento</h3>
                  <p>
                ...
                <section className="space-y-2">
                  <h3 className="text-base font-semibold text-carbon pt-2">4. Disciplina y Convivencia</h3>
                  <p>
            ...
            {activeTab === 'descargo' && (
              <article className="space-y-6 animate-fade-in text-gray-600 text-sm sm:text-[15px] leading-relaxed">
                ...
                <section className="space-y-2">
                  <h3 className="text-base font-semibold text-carbon pt-2">1. Asunción de Riesgos Inherentes</h3>
                  <p>
                ...
                <section className="space-y-2">
                  <h3 className="text-base font-semibold text-carbon pt-2">2. Declaración de Aptitud Física</h3>
                ...
                <section className="space-y-2">
                  <h3 className="text-base font-semibold text-carbon pt-2">3. Protocolo de Primeros Auxilios</h3>
                  <p>
            ...
            {activeTab === 'imagen' && (
              <article className="space-y-6 animate-fade-in text-gray-600 text-sm sm:text-[15px] leading-relaxed">
                <header className="border-b border-gray-200/80 pb-4">
                  <h2 className="text-2xl sm:text-3xl font-semibold text-carbon tracking-tight">
                    Uso de Imagen y Protección de Menores
                  </h2>
                  <p className="text-xs text-gray-500 mt-1">
                ...
                <section className="space-y-2">
                  <h3 className="text-base font-semibold text-carbon pt-2">1. Finalidad Deportiva e Institucional</h3>
                  <p>
                ...
                <section className="space-y-2">
                  <h3 className="text-base font-semibold text-carbon pt-2">2. Cuidado de la Dignidad del Menor</h3>
                  <p>
                ...
                <section className="space-y-2 border-l-2 border-gray-300 pl-4 py-1 my-4 bg-gray-50/40 rounded-r">
                  <h3 className="text-sm font-semibold text-carbon">3. Carácter Voluntario y Revocatoria</h3>
                  <p className="text-xs sm:text-sm text-gray-600">
            ...
            {activeTab === 'cookies' && (
              <article className="space-y-6 animate-fade-in text-gray-600 text-sm sm:text-[15px] leading-relaxed">
                ...
                <section className="space-y-2">
                  <h3 className="text-base font-semibold text-carbon pt-2">1. Uso de Cookies Técnicas</h3>
                  <p>
                ...
                <section className="space-y-2">
                  <h3 className="text-base font-semibold text-carbon pt-2">2. Cero Rastreo Publicitario</h3>
                  <p>
                ...
                <section className="space-y-2">
                  <h3 className="text-base font-semibold text-carbon pt-2">3. Cifrado y Conexión Segura</h3>
                  <p>
                ...
                <section className="space-y-2">
                  <h3 className="text-base font-semibold text-carbon pt-2">4. Control en el Navegador</h3>
                  <p>
