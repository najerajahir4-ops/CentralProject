  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={title}>
      <div className="flex flex-col items-center text-center space-y-4 py-2">
        ...
        <div className="flex justify-center gap-4 w-full mt-8 pt-6 border-t border-gray-100 dark:border-white/10">
          <button
            onClick={onClose}
          ...
          <button
            ...
            className="px-6 py-2.5 rounded-xl font-bold text-white bg-rojo-impacto hover:bg-red-700 shadow-lg shadow-red-500/30 transition-colors"
          >
            Sí, Eliminar
          </button>
        </div>
